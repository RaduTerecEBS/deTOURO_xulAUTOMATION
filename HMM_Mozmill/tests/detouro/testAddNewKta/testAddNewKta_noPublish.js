...
function testAddNewKta() {
  ...
  ktaNu = assignedKtaNumber.getNode().textContent.slice(13, 17);
  ...
  controller.assert(function () {
    return ktaNu === numberField.getNode().textContent;
  }, "We are present in the Neu Angelegt menu " + numberField.getNode().textContent);
}
